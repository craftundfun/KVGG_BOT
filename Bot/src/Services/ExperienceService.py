...
from Bot.src.Repository.DiscordUserRepository import getDiscordUser, getDiscordUserById
from Bot.src.Services.AchievementService import AchievementService
...
class ExperienceService:
    ...
    async def handleXpRequest(self, member: Member, user: Member) -> string:
        ...
        from Bot.src.Services.ProcessUserInput import getTagStringFromId
