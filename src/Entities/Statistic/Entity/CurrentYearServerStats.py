...
class CurrentYearServerStats(Base):
    __tablename__ = 'current_year_server_stats'
    ...
    def __repr__(self):
        return f"CurrentYearServerStats(value={self.value}, statistic_type={self.statistic_type})"
