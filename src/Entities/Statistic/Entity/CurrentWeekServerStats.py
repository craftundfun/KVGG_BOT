...
class CurrentWeekServerStats(Base):
    __tablename__ = 'current_week_server_stats'
    ...
    def __repr__(self):
        return f"CurrentWeekServerStats(value={self.value}, statistic_type={self.statistic_type})"
